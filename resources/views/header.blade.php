<div id="header">
						...
						@if(Session::has('cart'))
							...
							<div class="cart-caption">
								...
								<div class="center">
									...
									<a href="{{route('empty-cart')}}" class="beta-btn primary text-center">Xóa Tất Cả <i class="fa fa-chevron-right"></i></a>
								</div>
							</div>
						@endif
						</div>
	...
	<div class="header-bottom" style="background-color: #0277b8;">
		<div class="container">
			<a class="visible-xs beta-menu-toggle pull-right" href="{{route('trang-chu')}}"><span class='beta-menu-toggle-text'>Menu</span> <i class="fa fa-bars"></i></a>
